<form wire:submit.prevent="update" class="max-w-4xl mx-auto">
    ...
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        ...
        <div>
            ...
            <input type="text" id="telefono" wire:model="telefono" value="{{ $telefono }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" />
            @error('telefono')
                <span class="text-red-500 text-sm">{{ $message }}</span>
            @enderror
        ...
        <label class="inline-flex items-center cursor-pointer">
            <input type="checkbox" wire:model.live="toggleEstado" class="sr-only peer">
            <div
        ...
        <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
            <div class="flex items-center ps-3">
                <input id="reclutador" type="radio" value="reclutador" wire:model.live="rol"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                    {{ $rol === 'reclutador' ? 'checked' : '' }}>
                <label for="reclutador" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Reclutador
                </label>
            </div>
        </li>
        <li class="w-full border-b border-gray-200 sm:border-b-0 sm:border-r dark:border-gray-600">
            <div class="flex items-center ps-3">
                <input id="candidato" type="radio" value="candidato" wire:model.live="rol"
                    class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-700 focus:ring-2 dark:bg-gray-600 dark:border-gray-500"
                    {{ $rol === 'candidato' ? 'checked' : '' }}>
                <label for="candidato" class="w-full py-3 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">
                    Candidato
                </label>
            </div>
        </li>
    ...
    @if ($rol === 'reclutador')
        <div class="mt-6">
            ...
            <input type="text" id="departamento" wire:model.live="departamento" value="{{ $departamento }}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
