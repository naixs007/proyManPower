                    ...
                    <tr
                        ...
                        <td class="px-6 py-4">
                            ...
                            @elseif ($user->hasRole('reclutador'))
                                <span class="text-yellow-600 font-semibold">Reclutador</span>
                            @elseif ($user->hasRole('candidato'))
                                <span class="text-green-600 font-semibold">Candidato</span>
                            @else
                                <span class="text-gray-900 whitespace-nowrap dark:text-white font-semibold">Sin
                                    rol</span>
                            @endif
                        </td>
                        <td class="px-6 py-4">
                            <a href="{{ route('admin.users.edit', $user->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline me-3">
                                <i class="fas fa-edit fa-lg"></i>
                            </a>
                            {{-- <a href="#"
                                class="font-medium text-green-600 dark:text-green-500 hover:underline me-3">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("confirmarEliminar").addEventListener("click", function(e) {
                ...
                if (idEliminar) {
                    ...
                    form.action = `{{ route('admin.users.destroy', '') }}/${idEliminar}`;
                    form.submit();
                }
            });
        });
