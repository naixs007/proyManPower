<x-admin-layout>
    ...
    <div class="py-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nueva Area</h1>
    ...
    <form action="{{route('admin.area.update', $area->id)}}" method="POST" class="max-w-4xl mx-auto">
        @method('PUT')
        @csrf
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
            <input type="text" id="nombre" name="nombre" value="{{$area->nombre}}"
