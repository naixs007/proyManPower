<x-admin-layout>
    ...
    <div class="py-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Areas</h1>
            ...
            <tbody>
                @forelse ($areas as $area)
                    <tr
                       ...
                       <td class="px-6 py-4">
                            <a href="{{ route('admin.area.edit', $area->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline me-3">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("confirmarEliminar").addEventListener("click", function(e) {
                ...
                if (idEliminar) {
                    ...
                    form.action = `{{ route('admin.area.destroy', '') }}/${idEliminar}`;
                    form.submit();
                }
            });
        });
