<x-admin-layout>
    ...
    <div class="py-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Actualizar Oferta</h1>
        <a href="{{ route('admin.oferta.index') }}"
    ...
    <form action="{{route('admin.oferta.update', $oferta->id)}}" method="POST" class="max-w-4xl mx-auto">
        @csrf
        @method('PUT')
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="cargo" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cargo</label>
                <input type="text" id="cargo" name="cargo" value="{{ $oferta->cargo }}"
            ...
            <div>
                ...
                <textarea id="descripcion" name="descripcion" rows="3"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                    placeholder="Descripción del puesto">{{ $oferta->descripcion }}</textarea>
                @error('descripcion')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div>
                ...
                <select id="estado" name="estado" 
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    <option value="A" {{ $oferta->estado === 'A' ? 'selected' : '' }}>Activa</option>
                    <option value="I" {{ $oferta->estado === 'I' ? 'selected' : '' }}>Inactiva</option>
                </select>
                @error('estado')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <select id="modalidad" name="modalidad"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white">
                    <option value="P" {{ $oferta->modalidad === 'P' ? 'selected' : '' }}>Presencial</option>
                    <option value="R" {{ $oferta->modalidad === 'R' ? 'selected' : '' }}>Remoto</option>
                    <option value="H" {{ $oferta->modalidad === 'H' ? 'selected' : '' }}>Híbrido</option>
                </select>
                @error('modalidad')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <input type="date" id="fecha_inicio" name="fecha_inicio" value="{{ \Carbon\Carbon::parse($oferta->fecha_inicio)->format('Y-m-d') }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" />
                @error('fecha_inicio')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <input type="date" id="fecha_fin" name="fecha_fin" value="{{ \Carbon\Carbon::parse($oferta->fecha_fin)->format('Y-m-d') }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" />
                @error('fecha_fin')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
                @enderror
            ...
            <div>
                ...
                <input type="number" step="0.01" id="salario_minimo" name="salario_minimo" value="{{ $oferta->salario_minimo }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                    placeholder="0.00" />
            ...
            <div>
                ...
                <input type="number" step="0.01" id="salario_maximo" name="salario_maximo" value="{{ $oferta->salario_maximo }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
                    placeholder="0.00" />
            ...
            <div>
                ...
                <select id="area_id" name="area_id"
                    ...
                    @foreach($areas as $area)
                        <option value="{{ $area->id }}" {{ $oferta->area_id == $area->id ? 'selected' : '' }}>{{ $area->nombre }}</option>
                    @endforeach
                </select>
                @error('area_id')
                    <span class="text-red-500 text-sm">{{ $message }}</span>
