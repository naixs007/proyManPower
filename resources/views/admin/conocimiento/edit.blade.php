<x-admin-layout>
    ...
    <form action="{{route('admin.conocimiento.update', $conocimiento->id)}}" method="POST" class="max-w-4xl mx-auto">
        @method('PUT')
        @csrf
    <div class="grid gap-6 mb-6 md:grid-cols-2">
        <div>
            <label for="nombre" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nombre</label>
            <input type="text" id="nombre" name="nombre" value="{{$conocimiento->nombre}}"
        ...
        <div>
            ...
            <input type="text" id="descripcion" name="descripcion" value="{{$conocimiento->descripcion}}"
                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
