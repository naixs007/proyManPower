<x-admin-layout>
    ...
    <div class="py-4 flex items-center justify-between">
        <h1 class="text-2xl font-semibold text-gray-900 dark:text-white">Nuevo Permiso</h1>
        <a href="{{ route('admin.users.index') }}"
    ...
    <form action="{{route('admin.permiso.store')}}" method="POST" class="max-w-4xl mx-auto">
        @csrf
