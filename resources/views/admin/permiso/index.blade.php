<x-admin-layout>
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="#"
                        class="ms-1 text-sm font-medium text-gray-700 hover:text-blue-600 md:ms-2 dark:text-gray-400 dark:hover:text-white">Permisos</a>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="py-4 flex items-center justify-between">
        ...
        <a href="{{route('admin.permiso.create')}}"
            ...
            <tbody>
                @forelse ($permisos as $permiso)
                    <tr
                       ...
                       <td class="px-6 py-4">
                            <a href="{{ route('admin.permiso.edit', $permiso->id) }}" class="font-medium text-blue-600 dark:text-blue-500 hover:underline me-3">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            document.getElementById("confirmarEliminar").addEventListener("click", function(e) {
                ...
                if (idEliminar) {
                    ...
                    form.action = `{{ route('admin.permiso.destroy', '') }}/${idEliminar}`;
                    form.submit();
                }
            });
        });
